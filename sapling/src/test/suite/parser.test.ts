...
suite('Parser Test Suite', () => {
  ...
  // TEST 15: Webpack Aliased Imports:
  describe('It should parse files with webpack config aliases when provided config file', () => {
    before(() => {
      file = path.join(__dirname, '../../../src/test/test_apps/test_14/src/client/index.tsx');
  ...
  // TEST 16: REQUIRE STATEMENTS WITH DESTRUCTURING, ALIASING
  ...
  // TEST 17: VARIABLE DECLARATION IMPORTS WITH DESTRUCTURING, ALIASING
